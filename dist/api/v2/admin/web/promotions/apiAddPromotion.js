...
exports.ApiAddPromotion = async (req, res, next) => {
    responseLogs_1.responseLogger.print("Calling Add Promotions...", req, res);
    ...
    let promoId = v4_1.default().toString();
    ...
    responseLogs_1.responseLogger.print("Completed Add Promotions...", req, res);
    res.json(messages_1.PublicInfo.infoCreated({ saleItem: new promotionSummary_1.PromotionSummary(newPromotion) }));
};
/*
