...
exports.ApiCreateBranch = async (req, res, next) => {
    ...
    fs.copyFile('public/cache/' + image, 'public/shop_images/' + image, async (err) => {
        ...
        try {
            ...
            responseLogs_1.responseLogger.print("Completed Create Branch...", req, res);
            res.json(messages_1.PublicInfo.infoCreated({ shop: new branchSummary_1.BranchSummary(newBranch) }));
        }
        catch (error) {
